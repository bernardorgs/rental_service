...
if (email === "graxa@gmail.com" && senha === "123456") {
  setUsuarioLogado({ nome: "Admin", tipo: "admin" });
  setMensagem("Login de administrador realizado com sucesso!");
} else {
  setUsuarioLogado({ nome: email, tipo: "cliente" });
  setMensagem("Login como cliente realizado com sucesso!");
}
